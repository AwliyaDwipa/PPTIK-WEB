...
import img1 from './assets/Rnews1(7).jpg'
import Footer from "../../homepage/footer";
import img2 from './assets/Rnews2(7).jpg'
import img3 from './assets/Rnews2(7).jpg'
    ...
    return ( 
        ...
        <div className="flex flex-col my-8 mx-12">
            ...
            <div className="flex flex-col my-4">
                <div className="my-4">
                    <h1 className="text-blue-600 text-2xl ">Serah Terima IoT Tracker Universitas Trilogi</h1>
