...
import img1 from './assets/foto3.jpeg'
    ...
    return ( 
        ...
        <div className="flex flex-col my-8 mx-12">
            ...
            <div className="flex flex-col my-4">
                <div className="my-4">
                    <h1 className="text-blue-600 text-2xl ">Diskusi dengan Universitas Bandar Lampung Administrasi Bisnis</h1>
